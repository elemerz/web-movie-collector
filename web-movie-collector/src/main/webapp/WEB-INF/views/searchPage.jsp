...
<form class="frm ui-helper-clearfix">
	...
	<ul id="infoSources" class="ui-layout-south">
		<c:forEach var="infoSource" items="${infoSources}">
			<li class="info-source"><input type="checkbox" value="${infoSource.id}" /><label for="source1">${infoSource.label}</label></li>
		</c:forEach>
	</ul>
	<textarea id="searchItemTmpl" class="ui-helper-hidden">
       	<li><a data-tooltipmsg={searchResult} href="#">{label}<strong class="search-term">remove</strong></a></li>
    </textarea>
</form>
